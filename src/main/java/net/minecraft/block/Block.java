...
public class Block
{
    ...
    public static final RegistryNamespacedDefaultedByKey<ResourceLocation, Block> BLOCK_REGISTRY = new RegistryNamespacedDefaultedByKey(AIR_ID);
    ...
    public static short getMultipliedIdFromBlock(Block block) {
        return (short) (BLOCK_REGISTRY.getIDForObject(block)*16);
    }

    public static short getShortIdFromBlock(Block blockIn)
    {
        return (short) BLOCK_REGISTRY.getIDForObject(blockIn);
    }

    public static int getIdFromBlock(Block blockIn)
    {
        return BLOCK_REGISTRY.getIDForObject(blockIn);
    }
    ...
    {
        return (Block) BLOCK_REGISTRY.getObjectById(id);
    }
    ...
    public static Block getBlockFromName(String name)
    {
        ...
        {
            return (Block) BLOCK_REGISTRY.getObject(resourcelocation);
        }
        else
        {
            try
            {
                return (Block) BLOCK_REGISTRY.getObjectById(Integer.parseInt(name));
            }
    ...
    {
        return "Block{" + BLOCK_REGISTRY.getNameForObject(this) + "}";
    }
    ...
    public static void registerBlocks()
    {
        ...
        registerBlock(85, "fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.OAK.getMapColor())).setHardness(2.0F).setResistance(5.0F).setSoundType(soundTypeWood).setUnlocalizedName("fence"));
        ...
        registerBlock(188, "spruce_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.SPRUCE.getMapColor())).setHardness(2.0F).setResistance(5.0F).setSoundType(soundTypeWood).setUnlocalizedName("spruceFence"));
        registerBlock(189, "birch_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.BIRCH.getMapColor())).setHardness(2.0F).setResistance(5.0F).setSoundType(soundTypeWood).setUnlocalizedName("birchFence"));
        registerBlock(190, "jungle_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.JUNGLE.getMapColor())).setHardness(2.0F).setResistance(5.0F).setSoundType(soundTypeWood).setUnlocalizedName("jungleFence"));
        registerBlock(191, "dark_oak_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.DARK_OAK.getMapColor())).setHardness(2.0F).setResistance(5.0F).setSoundType(soundTypeWood).setUnlocalizedName("darkOakFence"));
        registerBlock(192, "acacia_fence", (new BlockFence(Material.wood, BlockPlanks.EnumType.ACACIA.getMapColor())).setHardness(2.0F).setResistance(5.0F).setSoundType(soundTypeWood).setUnlocalizedName("acaciaFence"));
...
//        registerBlock(202, "amethyst_block", (new Block(Material.iron, MapColor.pinkColor)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setUnlocalizedName("blockAmethyst").setCreativeTab(CreativeTabs.tabBlock));
       ...
       // After 218, Minecraft has shulker boxes, concrete, etc. These will not be used, so we can put anything here.
        ...
        BLOCK_REGISTRY.validateKey();

        for (Block block13 : BLOCK_REGISTRY)
        {
        ...
        for (Block block14 : BLOCK_REGISTRY)
        {
            for (IBlockState iblockstate : block14.getBlockState().getValidStates())
            {
                int i = BLOCK_REGISTRY.getIDForObject(block14) << 4 | block14.getMetaFromState(iblockstate);
                BLOCK_STATE_IDS.put(iblockstate, i);
                if(!BLOCK_IDS.containsKey(block14)) {
                    System.out.println(i + " | " + block14.toString());
    ...
    {
        BLOCK_REGISTRY.register(id, textualID, block_);
    }
