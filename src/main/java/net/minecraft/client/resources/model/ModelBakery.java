...
public class ModelBakery
{
    ...
    private void registerVariantNames()
    {
        ...
        this.variantNames.put(Item.getItemFromBlock(Blocks.stone), Lists.newArrayList(new String[] {"stone", "granite", "granite_smooth", "diorite", "diorite_smooth", "andesite", "andesite_smooth","blackstone"}));
        ...
        this.variantNames.put(Item.getItemFromBlock(Blocks.furnace), Lists.newArrayList(new String[] {"furnace", "forge"}));
        this.variantNames.put(Item.getItemFromBlock(Blocks.anvil), Lists.newArrayList(new String[] {
                "anvil_intact",             // 0
                "unused",                   // 1
                "anvil_slightly_damaged",    // 2
                "unused",                   // 3
                "anvil_very_damaged",       // 4
                "unused",                   // 5
                "unused",                   // 6
                "unused",                   // 7
                "anvil_intact_diamond",  // 8
                "unused",                   // 9
                "anvil_slightly_damaged_diamond", // 10
                "unused",                   // 11
                "anvil_very_damaged_diamond",      // 12
                "unused",
                "unused",
                "unused",
                "unused"
        ...
        this.variantNames.put(Items.bundle, Lists.newArrayList(new String[] {"bundle","bundle_filled"}));
        this.variantNames.put(Items.steel_crossbow, Lists.newArrayList(new String[] {"steel_crossbow","steel_crossbow_loaded"}));
