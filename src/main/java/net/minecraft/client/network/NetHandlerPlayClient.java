...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
     ...
     * Brewing stand, Villager merchant, Beacon, Anvil, Hopper, Dropper, Horse, Research Bench
     */
    public void handleOpenWindow(S2DPacketOpenWindow packetIn)
    {
        ...
        // Packet mechanic mineshaft
        else if("minecraft:research".equals(packetIn.getGuiId())) {
            entityplayersp.displayResearchGui();
            entityplayersp.openContainer.windowId = packetIn.getWindowId();
        }
    ...
    public void handleEffect(S28PacketEffect packetIn)
    {
        ...
        {
            this.gameController.theWorld.playBroadcastSound(packetIn.getSoundType(), packetIn.getSoundPos().getX(),packetIn.getSoundPos().getY(),packetIn.getSoundPos().getZ(), packetIn.getSoundData());
        }
        else
        {
