...
{
    public ModelLargeChest(boolean isOpen, boolean visible)
    {
        super(isOpen,visible);
        ...
        if(visible) {
            if (isOpen) {
                ...
                this.chestBelow = (new ModelRenderer(this, 0, 0)).setTextureSize(128, 64);
                this.chestBelow.addBox(0.0F, 0.0F, 0.0F, 30, 14 /*was 10*/, 14, 0.0F);
                this.chestBelow.offsetY = -0.25f;
            }
