...
public class Item {
    ...
    public static void registerItems() {
        ...
        })).setUnlocalizedName("lit_furnace"));
...
//        registerItem(valueBase+498, "amethyst", (new Item()).setUnlocalizedName("amethyst").setCreativeTab(CreativeTabs.tabMaterials));
        ...
        registerItem(valueBase+ 520, "fire_staff", (new ItemStaff(1,50)).setUnlocalizedName("staffFire").setCreativeTab(CreativeTabs.tabCombat).setFull3D());
        registerItem(valueBase+ 521, "water_staff", (new ItemStaff(0,50)).setUnlocalizedName("staffWater").setCreativeTab(CreativeTabs.tabCombat).setFull3D());
...
//        registerItem(valueBase+5011, "cave_map", (new ItemEmptyMap()).setUnlocalizedName("emptyCaveMap"));
    ...
    {
        registerItem(Block.getIdFromBlock(blockIn), (ResourceLocation)Block.BLOCK_REGISTRY.getNameForObject(blockIn), itemIn);
