...
//                        IBlockState iblockstate1 = iblockstate.withRotation(p_189960_4_.getRotation());
                        ...
                        if (p_189960_1_.setBlockState(blockpos, /*iblockstate1*/ template$blockinfo1.blockState, p_189960_5_) && template$blockinfo1.tileentityData != null)
                        {
    ...
    private void addEntitiesToWorld(World worldIn, BlockPos pos, Mirror mirrorIn, Rotation rotationIn, @Nullable StructureBoundingBox aabb)
    {
        for (Template.EntityInfo template$entityinfo : this.entities)
        {
            ...
            if (aabb == null || aabb.isVecInside(blockpos))
            {
                ...
                nbttagcompound.setString("UUID", String.valueOf(UUID.randomUUID()));
                Entity entity;
...
//                    f = f + (entity.rotationYaw - entity.getRotatedYaw(rotationIn));
                    entity.setLocationAndAngles(vec3d1.xCoord, vec3d1.yCoord, vec3d1.zCoord, 0, entity.rotationPitch);
...
//    }
    ...
    public void read(NBTTagCompound compound)
    {
        ...
        this.size = new BlockPos(nbttaglist.getFloatAt(0), nbttaglist.getFloatAt(1), nbttaglist.getFloatAt(2));
        ...
        for (int j = 0; j < nbttaglist3.tagCount(); ++j)
        {
            ...
            BlockPos blockpos = new BlockPos(nbttaglist2.getFloatAt(0), nbttaglist2.getFloatAt(1), nbttaglist2.getFloatAt(2));
        ...
        for (int k = 0; k < nbttaglist4.tagCount(); ++k)
        {
            ...
            Vec3 vec3d = new Vec3(nbttaglist5.getDoubleAt(0), nbttaglist5.getDoubleAt(1), nbttaglist5.getDoubleAt(2));
            NBTTagList nbttaglist6 = nbttagcompound3.getTagList("blockPos", 3);
            BlockPos blockpos1 = new BlockPos(nbttaglist6.getFloatAt(0), nbttaglist6.getFloatAt(1), nbttaglist6.getFloatAt(2));
    ...
    static class BasicPalette implements Iterable<IBlockState>
    {
        ...
        {
            this.ids = new ObjectIntIdentityMap<>();
        }
    ...
    public static class EntityInfo
    {
        ...
        public EntityInfo(Vec3 vecIn, BlockPos posIn, NBTTagCompound compoundIn)
        {
            this.pos = vecIn;
            this.blockPos = posIn;
