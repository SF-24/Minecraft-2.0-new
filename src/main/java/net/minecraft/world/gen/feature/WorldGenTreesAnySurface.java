...
public class WorldGenTreesAnySurface extends WorldGenAbstractTree
{
    ...
    public WorldGenTreesAnySurface(boolean p_i46446_1_, int height, IBlockState log, IBlockState leaves, boolean vines, boolean allowStone)
    {
        super(p_i46446_1_);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos x)
    {
        ...
        if (x.getY() >= 1 && x.getY() + i + 1 <= 256)
        {
            ...
            else
            {
                ...
                if ((block1 == Blocks.grass || block1 == Blocks.dirt || block1 == Blocks.farmland || block1 == Blocks.gravel || block1 == Blocks.sand || block1 == Blocks.stone) && x.getY() < 256 - i - 1)
                {
