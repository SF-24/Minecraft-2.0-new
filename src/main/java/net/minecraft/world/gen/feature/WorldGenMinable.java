...
public class WorldGenMinable extends WorldGenerator
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos x)
    {
        ...
        double d0 = (double)((float)(x.getX() + 8) + MathHelper.sin(f) * (float)this.numberOfBlocks / 8.0F);
        double d1 = (double)((float)(x.getX() + 8) - MathHelper.sin(f) * (float)this.numberOfBlocks / 8.0F);
        double d2 = (double)((float)(x.getZ() + 8) + MathHelper.cos(f) * (float)this.numberOfBlocks / 8.0F);
        double d3 = (double)((float)(x.getZ() + 8) - MathHelper.cos(f) * (float)this.numberOfBlocks / 8.0F);
        double d4 = (double)(x.getY() + rand.nextInt(3) - 2);
        double d5 = (double)(x.getY() + rand.nextInt(3) - 2);
